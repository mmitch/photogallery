#!/bin/bash
# $Id: photogallery.sh,v 1.12 2007-06-24 10:10:13 mitch Exp $
#
...
html_foot() {
    echo '<hl><p><small><i>generated on ' "$(LANG=${DATELANG} date)" 'by $Id: photogallery.sh,v 1.12 2007-06-24 10:10:13 mitch Exp $</i></small></p></body></html>'
}
