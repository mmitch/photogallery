#!/bin/bash
# $Id: photogallery.sh,v 1.2 2007-06-22 20:56:41 mitch Exp $
#
...
html_foot() {
    echo '<hl><p><small><i>generated by $Id: photogallery.sh,v 1.2 2007-06-22 20:56:41 mitch Exp $</i></small></p></body></html>'
}
